...
## [3.0.3] - Four bugs from an external AI review, each independently verified against the code

An external AI review flagged 13 points, 4 marked as likely real bugs. None were taken at face value — each was checked directly against the current code before anything was changed. All four held up (one, #3 below, turned out narrower than described). No breaking changes.
